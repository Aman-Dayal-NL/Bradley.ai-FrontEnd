          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', mt: 1 }}>
            ...
            {hvacOperation === "Seasonal Switchover" && (
              <i style={{ fontSize: '0.65rem', marginTop: 6, marginLeft: 450, textAlign: 'right', color: '#666' }}>
                {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} assumes a Fall switchover in Mid-October and a Spring<br />switchover in the last week of March for its energy calculations
              </i>
            )}
          </Box>
        </Box>
