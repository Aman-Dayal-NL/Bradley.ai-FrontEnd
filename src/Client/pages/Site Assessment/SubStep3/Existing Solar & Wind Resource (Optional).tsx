  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', p: 1, pr: 4, pl: 1, pt: 1 }}>
      ...
      <Typography variant="h6" sx={{ mb: 1, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.85rem', fontWeight: 'bold', textAlign: 'center' }}>
        ...
        <br />
        Let {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} Know If You Have Existing Solar Assets
      </Typography>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: '10px', pb: '10px', px: '160px' }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          <Typography sx={{ mt: 0, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', minWidth: '200px', flex: 1 }}>
            <i><b>*</b>If you select <b>Yes</b>, {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} will assess your site's wind resource potential using <b>Wind Resource Maps, Data and Geo-Spatial Data for North America</b> from the <b>National Renewable Energy Lab, Department of Energy</b>.</i>
          </Typography>
        </Box>
      </Box>
    </Box>
