        ...
        <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 2, pt: '10px', pb: '10px', pl: '160px', pr: '160px' }}>
          <Box sx={{ alignItems: 'center', gap: 1 }}>
            ...
            <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', mt: 3, textAlign: 'justify', lineHeight: 1.8 }}>
              ...
              {' '} (Customer) appoints {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} as its Agent to obtain any and all usage information {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} deems necessary to EVALUATE the Customer electricity, gas, or all steam supply at our location in{' '}
          ...
          <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', minWidth: '150px', mt: 3, textAlign: 'justify' }}>
            I/We authorize {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} to retrieve/receive demand/consumption/billing information through applicable means for the electricity account numbers specified below as well as any future accounts that Customer requests to add to the applicable electricity supply agreement. I/We authorize {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} to complete any web-based authorization form on the relevant electric distribution company website(s) for the electricity account numbers specified below as well as any future accounts that Customer requests to add to the applicable electricity supply agreement. Unless otherwise required by state regulation, this authorization shall be effective immediately and remain in effect for as long as there is an electricity supply agreement between Customer and {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'}. {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} may assign this Letter of Authorization to other entities.
          </Typography>
