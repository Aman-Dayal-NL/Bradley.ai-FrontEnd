        ...
        <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 2, pt: '10px', pb: '10px', pl: '160px', pr: '160px' }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <Typography sx={{ mt: 1, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', minWidth: '200px', flex: 1 }}>
              <i><b>* </b>If <b>Yes</b>, please provide details in the fields or upload the agreement and {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} will autopopulate the fields for you.</i><br />
              <i><b>** </b>If <b>No</b>, {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} will assume you are on the standard offer rate from the regulated electric utility and will gather data from the utility tariff.</i>
            </Typography>
          </Box>
        </Box>
      </Box>
