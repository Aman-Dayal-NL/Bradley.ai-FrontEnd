    ...
    >
      ...
      >
        ...
        >
          ...
          >
            This is the first step in establishing a Distributed Energy Resource (DER) concept that is site-specific and personalized to attain your goals. I am an Energy Expert AI Agent, named {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'}. I will ask you a series of questions regarding the use and operation of your facility, gather key data about your energy use in order to conceptually design the ideal DER system, identify potential incentives (rebates, grants, tax benefits), and deliver the technical and financial attributes, in both qualitative and quantitative terms, that provide actionable metrics to decide the next steps in your pursuit of DER. Additionally {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} offers an option to provide up to the minute emission calculations (Nox, Sox, CO2) that can be used for internal or external reporting requirements.
          </Typography>
          <Typography
            sx={{
              fontFamily: 'Nunito Sans, sans-serif',
