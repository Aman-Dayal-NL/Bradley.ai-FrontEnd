...
const resourcesData: ResourceItem[] = [
  ...
  { id: 'emission-reporting', title: 'EMISSION REPORTING PROCESS DERLabsIQ', description: "Standard operating procedures and process flow for compiling and reporting emission data using the DERLabsIQ platform.", watermarkText: 'ERP', filePath: 'https://docs.google.com/document/d/138aYTAjTyn5_UxJTEC54EkfAoZ19oOYNpkvcCp3Q03A/edit?usp=sharing', downloadName: 'EMISSION REPORTING PROCESS DERLabsIQ.docx', fileType: 'doc' },
