        ...
        <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 2, pt: '10px', pb: '10px', pl: '160px', pr: '160px' }}>
          <Box sx={{ alignItems: 'center', gap: 1 }}>
            ...
            <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', mt: 3, textAlign: 'justify', lineHeight: 1.8 }}>
              ...
              {' '} (Customer) appoints {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} as its Agent to obtain any and all usage information {window.location.pathname === '/demo' ? 'EmissionCheckIQ+' : 'DERLabsIQ'} deems necessary to EVALUATE the Customer electricity, gas, or all steam supply at our location{addresses && addresses.length > 1 ? 's' : ''} in{' '}
