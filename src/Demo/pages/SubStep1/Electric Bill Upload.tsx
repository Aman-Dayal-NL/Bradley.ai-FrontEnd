...
>
  ...
  >
    {address.address}
          ...
          <Typography sx={{ mt: 0, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', minWidth: '200px', flex: 1 }}><i><b>*</b><b>{window.location.pathname === '/emissioncheckiq' ? 'EmissionCheckIQ+' : 'DERLabsIQ'}</b> prefers to gain direct access to the Utility profile usage of your utility meter. The <b>LOA</b> enables <b>{window.location.pathname === '/emissioncheckiq' ? 'EmissionCheckIQ+' : 'DERLabsIQ'}</b> to pull data directly from the utility to instantly update your <b>GHG</b> emission profile.</i></Typography>
        </Box>
      </Box>
    </Box>
  );
